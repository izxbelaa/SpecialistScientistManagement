        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Manage Academies</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="../index.php">Home</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Manage Academies</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="academyModalLabel">Add New Academy</h5>
                ...
                <div class="modal-body">
                    <form id="academyForm">
                        ...
                        <div class="mb-3">
                            <label for="academyCode" class="form-label">Academy Code *</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="saveAcademy">Save</button>
                </div>
            </div>
        </div>
    </div>
