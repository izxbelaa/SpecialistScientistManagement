    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="../index.php" class="nav-item nav-link">Αρχική</a>
                <a href="about.php" class="nav-item nav-link">Σχετικά</a>
                <a href="application.php" class="nav-item nav-link">Αιτήσεις</a>
                <a href="courses.php" class="nav-item nav-link">Μαθήματα</a>
                <a href="lms-reports.php" class="nav-item nav-link active">Αναφορές LMS</a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->
