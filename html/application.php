...
<body>
        ...
        <div class="container py-5">
          <div class="row justify-content-center">
            <div class="col-lg-10 text-center">
              <h1 class="display-3 text-white animated slideInDown">Επιλογή Αίτησης</h1>
 ...
 <!-- Application Selection Dynamic Container -->
 <div class="container my-5">
    <div class="row justify-content-center">
      <div class="col-lg-10 text-center mb-4">
        <h2 class="mb-4">Διαθέσιμες Αιτήσεις</h2>
        <p>Επιλέξτε τον τύπο αίτησης που θέλετε να συμπληρώσετε:</p>
      </div>
    </div>
    <div class="row g-4" id="applicationsContainer"></div>
  </div>
