                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                ...
                                <p class="fs-5 text-white mb-4 pb-2">Εάν επιθυμείτε να γίνετε μέλος της ομάδας των Ειδικών Επιστημόνων του TEPAΚ, υποβάλετε την αίτησή σας μέσω της εγγραφής. Συμπληρώστε τα στοιχεία σας για να αποκτήσετε πρόσβαση σε εξειδικευμένες υπηρεσίες, εκπαιδευτικά προγράμματα και μοναδικές ευκαιρίες – μαζί, διαμορφώνουμε το μέλλον της επιστήμης!</p>
                                <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Read More</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid" src="asssets/img/cat-3.jpg" alt="">
                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
